...
function addValue(value) {
    if (value === '.') {
        ...
        const lastOperatorIndex = expression.search(/_[+\-*/]/);
        //Find the last index of the last decimal in th eexpression
        ...
        //Check if this is the first decimal in hte current number or if the expression is empty
...
function evaluateExpression() {
    ...
    //3+4+5-5/2 = result
    return isNaN(evalResult) || !isFinite(evalResult) // Checks if evalResult isNaN or infinite. If true, return a space character
    ? ' '
    : evalResult < 1 
